...
def predict(model_path, x): 
    ...
    Args:
        model_path (str): Path of h5 model weights for the nestmatic model.
...
def validate(x, y, model_path):
    ...
    return model.evaluate(x.reshape((1,128,128,20)), y.reshape((1,128,128,24)))
